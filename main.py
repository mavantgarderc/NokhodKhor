...
blinky_img = pygame.transform.scale(
    pygame.image.load(f"assets/ghost_images/red.png"), (42, 42)
)
pinky_img = pygame.transform.scale(
    pygame.image.load(f"assets/ghost_images/pink.png"), (42, 42)
)
inky_img = pygame.transform.scale(
    pygame.image.load(f"assets/ghost_images/blue.png"), (42, 42)
)
clyde_img = pygame.transform.scale(
    pygame.image.load(f"assets/ghost_images/orange.png"), (42, 42)
)
spooked_img = pygame.transform.scale(
    pygame.image.load(f"assets/ghost_images/powerup.png"), (42, 42)
)
dead_img = pygame.transform.scale(
    pygame.image.load(f"assets/ghost_images/dead.png"), (42, 42)
)
player_x = 450
player_y = 663
direction = 0
...
def soft_reset():
    ...
    global eaten_ghost, blinky_dead, inky_dead, pinky_dead, clyde_dead
    global powerup, power_counter, startup_counter
...
def get_targets(blink_x, blink_y, ink_x, ink_y, pink_x, pink_y, clyd_x, clyd_y):
    ...
    if powerup:
        ...
        # Pinky (fixed: now respects eaten_ghost[2])
